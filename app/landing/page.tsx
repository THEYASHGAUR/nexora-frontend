    ...
    >
      ...
      >
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <GradientButton href="#pricing">Start Free Interview</GradientButton>
        </div>
      ...
      {open ? (
        <div className="border-t border-border bg-background/95 px-5 py-4 backdrop-blur-xl md:hidden">
          <div className="flex flex-col gap-1">
            ...
            <GradientButton href="#pricing" className="mt-2 justify-center">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-14 px-5 lg:grid-cols-[1.05fr_1fr]">
        <motion.div variants={stagger} initial="hidden" animate="show">
          ...
          <motion.div variants={fadeUp} className="mt-8 flex flex-wrap items-center gap-3">
            <GradientButton href="#pricing" className="px-5 py-3">
    ...
    <section id="how-it-works" className="relative py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-5">
        ...
        <div ref={ref} className="relative mx-auto mt-16 max-w-3xl">
          <div className="absolute top-2 bottom-2 left-[19px] w-px bg-border md:left-1/2" />
          <motion.div
            style={{ scaleY: height }}
            className="bg-brand-gradient absolute top-2 bottom-2 left-[19px] w-px origin-top md:left-1/2"
          />
          <div className="space-y-10">
            {STEPS.map((s, i) => (
              <Reveal key={s.t} delay={i * 0.05}>
                ...
                >
                  <span
                    className={`bg-brand-gradient absolute top-1 left-[11px] grid size-[18px] place-items-center rounded-full ring-4 ring-background md:left-auto ${
        ...
        >
          {PLANS.map((p) => (
            ...
            >
              ...
              {p.featured ? (
                <GradientButton href="#top" className="mt-7 w-full justify-center py-3">
                  Get Pro
                </GradientButton>
              ) : (
                <GhostButton href="#top" className="mt-7 w-full justify-center py-3">
                  Choose {p.name}
                </GhostButton>
              )}
            </motion.div>
      ...
      <Reveal>
        <div className="noise relative mx-auto max-w-5xl overflow-hidden rounded-3xl border border-border bg-surface px-6 py-20 text-center">
          ...
          <div className="relative mt-8 flex justify-center">
            <GradientButton href="#pricing" className="px-6 py-3.5 text-[15px]">
